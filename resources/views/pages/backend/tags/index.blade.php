...
<div class="container-fluid">
    ...
    <div class="d-sm-flex justify-content-end mb-4">
        <a href="{{ route('tags.create') }}" class="btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-100"></i> Tambah Kategori Berita
        </a>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="tagNews" 
                       ...
                       width="100%" cellspacing="0" data-form="deleteForm">
